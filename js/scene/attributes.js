...
// Атрибуты человека. Чтобы добавить новый — допиши сюда строку и создай хранилище в stores.js.
// slot: куда попадает в фразу — "adj" (прилагательное перед «man/woman»), "hair", "eyes", "skin".
// adultOnly: набор недоступен, пока человеку нет 18.
